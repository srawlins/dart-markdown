...
class ParagraphSyntax extends BlockSyntax {
  ...
  static final RegExp _reflinkDefinitionStart = new RegExp(r'[ ]{0,3}\[');
    ...
    loopOverDefinitions: while (true) {
      ...
      if (_parseReflinkDefinition(parser, contents)) {
        ...
        while (j >= i) {
          ...
          // Iterable allocation followed by a big 'ole String allocation, but
          // we must walk backwards, checking each range...
